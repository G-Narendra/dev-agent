...
MCP_SERVERS = {
    ...
    "chrome-devtools": {
        ...
        "description": "Chrome DevTools Protocol for debugging and automation",
        "category": "Browser",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-chrome-devtools"],
        "url": "https://github.com/nicholasoxford/mcp-chrome-devtools",
    },
    "browserbase": {
        "name": "Browserbase MCP",
        "description": "Cloud browser for headless automation",
        "category": "Browser",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@browserbase/mcp-server"],
        "env": {"BROWSERBASE_API_KEY": "", "BROWSERBASE_PROJECT_ID": ""},
        "url": "https://github.com/browserbase/mcp-server",
    },
    ...
    "vercel": {
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-vercel"],
        "url": "https://github.com/nicholasoxford/mcp-vercel",
    },
    "railway": {
        "name": "Railway MCP",
        ...
        "url": "https://github.com/nicholasoxford/mcp-railway",
    },
    "aws-s3": {
        "name": "AWS S3 MCP",
        "description": "S3 bucket management and file operations",
        "category": "Cloud Storage",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-aws-s3"],
        "env": {"AWS_ACCESS_KEY_ID": "", "AWS_SECRET_ACCESS_KEY": ""},
        "url": "https://github.com/nicholasoxford/mcp-aws-s3",
    },
    "terraform": {
        "name": "Terraform MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-terraform"],
        "url": "https://github.com/nicholasoxford/mcp-terraform",
    },
    "fly-io": {
        "name": "Fly.io MCP",
        "description": "Deploy apps to Fly.io global edge platform",
        "category": "Cloud",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-fly-io"],
        "url": "https://github.com/nicholasoxford/mcp-fly-io",
    },
    "render": {
        "name": "Render MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-render"],
        "url": "https://github.com/nicholasoxford/mcp-render",
    },
    ...
    "discord": {
        ...
        "url": "https://github.com/nicholasoxford/mcp-discord",
    },
    "telegram": {
        "name": "Telegram MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-telegram"],
        "env": {"TELEGRAM_BOT_TOKEN": ""},
        "url": "https://github.com/nicholasoxford/mcp-telegram",
    },
    "email": {
        "name": "Email MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-email"],
        "env": {"SMTP_HOST": "", "SMTP_PORT": "", "SMTP_USER": "", "SMTP_PASS": ""},
        "url": "https://github.com/nicholasoxford/mcp-email",
    },
    ...
    "trello": {
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-trello"],
        "env": {"TRELLO_API_KEY": "", "TRELLO_TOKEN": ""},
        "url": "https://github.com/nicholasoxford/mcp-trello",
    },
    "asana": {
        "name": "Asana MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-asana"],
        "env": {"ASANA_ACCESS_TOKEN": ""},
        "url": "https://github.com/nicholasoxford/mcp-asana",
    },
    "jira": {
        "name": "Jira MCP",
        ...
        "url": "https://github.com/nicholasoxford/mcp-jira",
    },
    "obsidian": {
        "name": "Obsidian MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-obsidian"],
        "url": "https://github.com/nicholasoxford/mcp-obsidian",
    },
    "google-calendar": {
        ...
        "env": {"GOOGLE_CLIENT_ID": "", "GOOGLE_CLIENT_SECRET": ""},
        "url": "https://github.com/nicholasoxford/mcp-google-calendar",
    },
    "google-docs": {
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-google-docs"],
        "env": {"GOOGLE_CLIENT_ID": "", "GOOGLE_CLIENT_SECRET": ""},
        "url": "https://github.com/nicholasoxford/mcp-google-docs",
    },
    "airtable": {
        "name": "Airtable MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-airtable"],
        "env": {"AIRTABLE_API_KEY": ""},
        "url": "https://github.com/nicholasoxford/mcp-airtable",
    },
    "todoist": {
        "name": "Todoist MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-todoist"],
        "env": {"TODOIST_API_TOKEN": ""},
        "url": "https://github.com/nicholasoxford/mcp-todoist",
    },
    ...
    "mongodb": {
        ...
        "env": {"MONGODB_URL": ""},
        "url": "https://github.com/nicholasoxford/mcp-mongodb",
    },
    "mysql": {
        "name": "MySQL MCP",
        "description": "MySQL database access and queries",
        "category": "Database",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-mysql"],
        "env": {"MYSQL_URL": ""},
        "url": "https://github.com/nicholasoxford/mcp-mysql",
    },
    "neo4j": {
        "name": "Neo4j MCP",
        "description": "Graph database queries and management",
        "category": "Database",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-neo4j"],
        "env": {"NEO4J_URL": "", "NEO4J_USER": "", "NEO4J_PASSWORD": ""},
        "url": "https://github.com/nicholasoxford/mcp-neo4j",
    },
    "elasticsearch": {
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-elasticsearch"],
        "env": {"ELASTICSEARCH_URL": ""},
        "url": "https://github.com/nicholasoxford/mcp-elasticsearch",
    },
    "firebase": {
        "name": "Firebase MCP",
        "description": "Firebase Firestore and Auth management",
        "category": "Database",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-firebase"],
        "url": "https://github.com/nicholasoxford/mcp-firebase",
    },
    "planetscale": {
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-planetscale"],
        "env": {"PLANETSCALE_TOKEN": ""},
        "url": "https://github.com/nicholasoxford/mcp-planetscale",
    },
    ...
    "duckduckgo": {
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-duckduckgo"],
        "url": "https://github.com/nicholasoxford/mcp-duckduckgo",
    },
    "wikipedia": {
        "name": "Wikipedia MCP",
        "description": "Access Wikipedia articles and knowledge",
        "category": "Search",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-wikipedia"],
        "url": "https://github.com/nicholasoxford/mcp-wikipedia",
    },
    "arxiv": {
        "name": "arXiv MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-arxiv"],
        "url": "https://github.com/nicholasoxford/mcp-arxiv",
    },
    "crawl4ai": {
        "name": "Crawl4AI MCP",
        "description": "AI-optimized web crawling and extraction",
        "category": "Web Scraping",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-crawl4ai"],
        "url": "https://github.com/nicholasoxford/mcp-crawl4ai",
    },

    # ── Design & Media ──────────────────────────────────────
    "figma": {
        "name": "Figma MCP",
        "description": "Read Figma designs and extract components",
        "category": "Design",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-figma"],
        "env": {"FIGMA_ACCESS_TOKEN": ""},
        "url": "https://github.com/nicholasoxford/mcp-figma",
    },
    "blender": {
        "name": "Blender MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-blender"],
        "url": "https://github.com/nicholasoxford/mcp-blender",
    },
    "google-fonts": {
        "name": "Google Fonts MCP",
        "description": "Access Google Fonts catalog",
        "category": "Design",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-google-fonts"],
        "url": "https://github.com/nicholasoxford/mcp-google-fonts",
    },
    "image-gen": {
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-image-gen"],
        "url": "https://github.com/nicholasoxford/mcp-image-gen",
    },
    ...
    "plaid": {
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-plaid"],
        "env": {"PLAID_CLIENT_ID": "", "PLAID_SECRET": ""},
        "url": "https://github.com/nicholasoxford/mcp-plaid",
    },
    "coinbase": {
        "name": "Coinbase MCP",
        "description": "Cryptocurrency trading and account data",
        "category": "Finance",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-coinbase"],
        "env": {"COINBASE_API_KEY": ""},
        "url": "https://github.com/nicholasoxford/mcp-coinbase",
    },
    "tax": {
        "name": "Tax MCP",
        "description": "Tax document processing and calculations",
        "category": "Finance",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-tax"],
        "url": "https://github.com/nicholasoxford/mcp-tax",
    },
    ...
    "posthog": {
        ...
        "env": {"POSTHOG_API_KEY": ""},
        "url": "https://github.com/nicholasoxford/mcp-posthog",
    },
    "datadog": {
        "name": "Datadog MCP",
        "description": "APM, logs, and infrastructure monitoring",
        "category": "Monitoring",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-datadog"],
        "env": {"DATADOG_API_KEY": "", "DATADOG_APP_KEY": ""},
        "url": "https://github.com/nicholasoxford/mcp-datadog",
    },
    "grafana": {
        "name": "Grafana MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-grafana"],
        "env": {"GRAFANA_URL": "", "GRAFANA_API_KEY": ""},
        "url": "https://github.com/nicholasoxford/mcp-grafana",
    },

    # ── Developer Tools ─────────────────────────────────────
    "nextjs": {
        "name": "Next.js DevTools MCP",
        "description": "Next.js development server integration",
        "category": "Development",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-nextjs"],
        "url": "https://github.com/nicholasoxford/mcp-nextjs",
    },
    "proxyman": {
        "name": "Proxyman MCP",
        "description": "API debugging and network inspection",
        "category": "Development",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-proxyman"],
        "url": "https://github.com/nicholasoxford/mcp-proxyman",
    },
    "postman": {
        "name": "Postman MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-postman"],
        "env": {"POSTMAN_API_KEY": ""},
        "url": "https://github.com/nicholasoxford/mcp-postman",
    },
    "turso": {
        "name": "Turso MCP",
        "description": "SQLite edge database management",
        "category": "Database",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-turso"],
        "env": {"TURSO_URL": "", "TURSO_TOKEN": ""},
        "url": "https://github.com/nicholasoxford/mcp-turso",
    },
    "react-native": {
        "name": "React Native MCP",
        "description": "React Native mobile development tools",
        "category": "Development",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-react-native"],
        "url": "https://github.com/nicholasoxford/mcp-react-native",
    },
    "expo": {
        "name": "Expo MCP",
        "description": "Expo SDK documentation for agents",
        "category": "Development",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-expo"],
        "url": "https://github.com/nicholasoxford/mcp-expo",
    },

    # ── Social Media ────────────────────────────────────────
    "twitter": {
        "name": "Twitter/X MCP",
        "description": "Post and read tweets via X API",
        "category": "Social Media",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-twitter"],
        "env": {"TWITTER_API_KEY": "", "TWITTER_API_SECRET": ""},
        "url": "https://github.com/nicholasoxford/mcp-twitter",
    },
    "reddit": {
        "name": "Reddit MCP",
        "description": "Read and post on Reddit",
        "category": "Social Media",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-reddit"],
        "env": {"REDDIT_CLIENT_ID": "", "REDDIT_CLIENT_SECRET": ""},
        "url": "https://github.com/nicholasoxford/mcp-reddit",
    },
    "linkedin": {
        "name": "LinkedIn MCP",
        "description": "LinkedIn profile and job data",
        "category": "Social Media",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-linkedin"],
        "url": "https://github.com/nicholasoxford/mcp-linkedin",
    },
    "youtube": {
        "name": "YouTube MCP",
        "description": "YouTube video search, transcripts, and channel data",
        "category": "Social Media",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-youtube"],
        "url": "https://github.com/nicholasoxford/mcp-youtube",
    },
    "mastodon": {
        "name": "Mastodon MCP",
        "description": "Fediverse social network integration",
        "category": "Social Media",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-mastodon"],
        "url": "https://github.com/nicholasoxford/mcp-mastodon",
    },

    # ── Education & Research ────────────────────────────────
    "pubmed": {
        "name": "PubMed MCP",
        "description": "Biomedical literature search from PubMed",
        "category": "Research",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-pubmed"],
        "url": "https://github.com/nicholasoxford/mcp-pubmed",
    },
    "semantic-scholar": {
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-semantic-scholar"],
        "url": "https://github.com/nicholasoxford/mcp-semantic-scholar",
    },
    ...
    "vault": {
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-vault"],
        "env": {"VAULT_ADDR": "", "VAULT_TOKEN": ""},
        "url": "https://github.com/nicholasoxford/mcp-vault",
    },
    "sonarcloud": {
        "name": "SonarCloud MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-sonarcloud"],
        "env": {"SONAR_TOKEN": ""},
        "url": "https://github.com/nicholasoxford/mcp-sonarcloud",
    },
    "snyk": {
        "name": "Snyk MCP",
        ...
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-snyk"],
        "env": {"SNYK_TOKEN": ""},
        "url": "https://github.com/nicholasoxford/mcp-snyk",
    },

    # ── E-Commerce ──────────────────────────────────────────
    "shopify": {
        "name": "Shopify MCP",
        "description": "Shopify store management and products",
        "category": "E-Commerce",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-shopify"],
        "env": {"SHOPIFY_ACCESS_TOKEN": ""},
        "url": "https://github.com/nicholasoxford/mcp-shopify",
    },
    "woocommerce": {
        "name": "WooCommerce MCP",
        "description": "WordPress WooCommerce store management",
        "category": "E-Commerce",
        "transport": "stdio",
        "command": "npx",
        "args": ["-y", "@anthropic-ai/mcp-woocommerce"],
        "env": {"WOOCOMMERCE_URL": "", "WOOCOMMERCE_KEY": "", "WOOCOMMERCE_SECRET": ""},
        "url": "https://github.com/nicholasoxford/mcp-woocommerce",
    },
}
